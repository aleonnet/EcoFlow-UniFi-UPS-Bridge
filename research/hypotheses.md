...
| **H12a** | Firmware update do UniFi OS apaga `authorized_keys`. | **UNKNOWN** | ↑ | docs/2026-08-31-2345-pesquisa-udr7-ups-terceiros.md:67-68 [S] ("credencial/chave SSH resetada em firmware update"). Mitigação: re-semear após update (runbook). |
