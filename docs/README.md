...
| `plans/2026-09-05-2330-handoff-0-8-2-o-leitor-recusado-pelo-nut.md` | aceito | **Handoff vivo**: 0.8.0→0.8.2 numa noite — autorização na abertura, o leitor que o NUT 2.8.5 recusava (medido no mini), o protocolo de teste do dono e o próximo passo |
