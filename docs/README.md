...
| `guides/2026-09-05-1100-runbook-acesso-ao-console-e-haos.md` | superado por `guides/2026-09-05-1327-…` | **Como conectar o console pelo App** (sem terminal, sem criar chave) e o que falta para o Home Assistant ler do nosso servidor NUT |
| `guides/2026-09-05-1327-runbook-o-home-assistant-com-tudo.md` | superado por `guides/2026-09-05-1930-…` | O Home Assistant com tudo o que o aplicativo mostra (era da 0.7.0: travas no arquivo, `LISTEN` à mão) |
| `guides/2026-09-05-1930-runbook-instalar-usar-e-remover-pelo-app.md` | superado por `guides/2026-09-05-2200-…` | **Instalar, usar e remover pelo App, sem terminal** (0.8.0): o disco, as três travas como interruptores, o Home Assistant pela rede, o cabo automático, o Lixo que remove tudo, e o roteiro de bancada |
| `guides/2026-09-05-2200-runbook-instalar-usar-e-remover-pelo-app.md` | aceito | **Instalar, usar e remover pelo App, sem terminal** (0.8.1): a autorização do serviço pedida na abertura (sem botão em Ajustes), o disco, as três travas como interruptores, o Home Assistant pela rede, o cabo automático, o Lixo que remove tudo, e o roteiro de bancada |
...
| `plans/2026-09-05-1727-handoff-0-7-0-driver-do-nut-e-o-disco.md` | superado por `plans/2026-09-05-2330-…` | **Handoff vivo**: a 0.7.0 publicada com o disco de instalação, o estado medido no ato (repositório, release, Mac mini), as três travas de arquivo, o que NÃO foi verificado e o próximo passo concreto |
| `plans/2026-09-05-2330-handoff-0-8-2-o-leitor-recusado-pelo-nut.md` | aceito | **Handoff vivo**: 0.8.0→0.8.3 numa noite — autorização na abertura, o leitor que o NUT recusava (medido no mini), a auditoria do registro (Lixo desfaz o registro; "no ar" exige resposta; textos HIG), o protocolo de teste do dono e o próximo passo |
| `plans/2026-09-05-1905-a-ux-determinada-inteira-0-8-0.md` | aceito | **O plano da 0.8.0**: a UX que o dono determinou, inteira — Lixo remove tudo, NUT dentro do App, as três travas viram interruptores, cabo automático sem botão, Home Assistant pela rede por interruptor, disco assinado e notarizado. Com o que a 0.7.0 não entregou, as decisões do dono desta sessão, e a bancada no Mac mini |
| `plans/2026-09-05-1905-a-ux-determinada-inteira-0-8-0-banca.md` | aceito | A revisão fria do plano da 0.8.0: duas rodadas reprovadas (três bloqueadores, todos corrigidos), escalada e decisão do dono |
| `plans/2026-09-06-1215-a-folha-do-river-e-compartilhar-os-registros-0-9-0.md` | aceito | **O plano da 0.9.0**: a folha do River com tudo o que a porta serial entrega (capacidade, quatro temperaturas, tempo para carga completa, entrada solar/DC), o cartão da proteção sem apavorar ("Armada", sem "alcance não verificado"), e **Compartilhar…** os registros (eventos + amostras em CSV + diário, num `.zip`). Com a correção de crença sobre firmware (não existe em fonte) |
