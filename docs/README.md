...
| `guides/2026-09-05-1327-runbook-o-home-assistant-com-tudo.md` | aceito | **O Home Assistant com tudo o que o aplicativo mostra**: os três aparelhos publicados, as ordens e as travas de cada uma, o cabo indo e voltando sozinho, o que o serviço escreve no `ups.conf`, e o roteiro de bancada com o resultado esperado de cada passo |
